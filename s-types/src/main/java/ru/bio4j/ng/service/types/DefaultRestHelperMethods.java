...
public class DefaultRestHelperMethods implements RestHelperMethods {
    ...
    @Override
    public ABeanPage getListAll(String bioCode, HttpServletRequest request) {
    ...
    @Override
    public ABeanPage getList(String bioCode, HttpServletRequest request) {
        OdacService odacService = getOdacService();
    ...
    @Override
    public HSSFWorkbook getExcel(String bioCode, HttpServletRequest request) {
        OdacService odacService = getOdacService();
    ...
    @Override
    public ABeanPage getList(String bioCode, Object prms, FilterAndSorter filterAndSorter, boolean forceCalcCount) {
        OdacService odacService = getOdacService();
    ...
    @Override
    public ABeanPage getListAll(String bioCode, Object prms, FilterAndSorter filterAndSorter, boolean forceCalcCount) {
        OdacService odacService = getOdacService();
    ...
    @Override
    public ABeanPage getList(String bioCode, Object prms) {
        OdacService odacService = getOdacService();
    ...
    @Override
    public ABeanPage getListAll(String bioCode, Object prms) {
        OdacService odacService = getOdacService();
    ...
    @Override
    public <T> List<T> getList(String bioCode, HttpServletRequest request, Class<T> calzz) {
        OdacService odacService = getOdacService();
        List<T> rslt = RestApiAdapter.loadPageExt(bioCode, request, odacService, calzz);
        return rslt;
    }
    @Override
    public <T> List<T> getListAll(String bioCode, HttpServletRequest request, Class<T> calzz) {
        OdacService odacService = getOdacService();
    ...
    @Override
    public <T> List<T> getList(String bioCode, Object prms, Class<T> calzz) {
        OdacService odacService = getOdacService();
    ...
    @Override
    public <T> List<T> getListAll(String bioCode, Object prms, Class<T> calzz) {
        OdacService odacService = getOdacService();
        return RestApiAdapter.loadAllExt(odacService, bioCode, prms, calzz);
    }

    @Override
    public <T> T getFirst(String bioCode, HttpServletRequest request, Class<T> calzz) {
        OdacService odacService = getOdacService();
        List<T> rslt = RestApiAdapter.loadAllExt(bioCode, request, odacService, calzz);
    ...
    @Override
    public <T> T getFirst(String bioCode, Object prms, Class<T> calzz) {
        OdacService odacService = getOdacService();
    ...
    @Override
    public ABean getFirst(String bioCode, HttpServletRequest request) {
        OdacService odacService = getOdacService();
        ABeanPage rslt = RestApiAdapter.loadPage(bioCode, request, odacService);
    ...
    @Override
    public <T> T getScalar(final String bioCode, final HttpServletRequest request, final Class<T> calzz, final T defaultValue) {
        OdacService odacService = getOdacService();
        return RestApiAdapter.selectScalar(bioCode, request, odacService, calzz, defaultValue);
    }

    @Override
    public <T> T getScalar(final String bioCode, final Object params, Class<T> calzz, T defaultValue) {
        OdacService odacService = getOdacService();
        return RestApiAdapter.selectScalar(bioCode, params, odacService, calzz, defaultValue, ServletContextHolder.getCurrentUser());
    }

    @Override
    public String getJson(String bioCode, HttpServletRequest request) {
        OdacService odacService = getOdacService();
    ...
    @Override
    public ABean getTotalCount(String bioCode, HttpServletRequest request) {
        OdacService odacService = getOdacService();
    ...
    @Override
    public StoreMetadata getMetadataOld(String bioCode) {
        OdacService odacService = getOdacService();
        return RestApiAdapter.getMetadataOld(bioCode, odacService);
    }

    @Override
    public ABean getMetadata(String bioCode) {
        OdacService odacService = getOdacService();
        return RestApiAdapter.getMetadata(bioCode, odacService);
    }

    @Override
    public ABean getSingle(String bioCode, Object id, HttpServletRequest request) {
        OdacService odacService = getOdacService();
    ...
    @Override
    public List<ABean> exctarctBean(HttpServletRequest request) {
        ...
        try {
            ...
            throw new BioError(String.format("Cannot decode json to bean: %s", abeanJson));
        }
        return abeans;
    }

    @Override
    public <T> T exctarctBean(HttpServletRequest request, Class<T> clazz) {
        T bean = null;
        String abeanJson = null;
        try {
            abeanJson = ((WrappedRequest)request).getBioQueryParams().jsonData;
            ...
            throw new BioError(String.format("Cannot decode json to bean(%s): %s", clazz.getCanonicalName(), abeanJson));
        }
        return bean;
    }

    @Override
    public ABean setBean(ABean bean, String attrName, Object attrValue, Class<?> attrType) {
        if(bean == null)
            bean = new ABean();
    ...
    @Override
    public <T> List<T> parsIdsTyped(String ids, Class<T> clazz) {
    ...
    @Override
    public List<Object> parsIds(String ids, Class<?> clazz) {
    ...
    @Override
    public ABean delete(String bioCode, List<Object> ids, HttpServletRequest request) {
        OdacService odacService = getOdacService();
        return RestApiAdapter.deleteBeans(bioCode, request, odacService, ids);
    }

    @Override
    public void exec(String bioCode, HttpServletRequest request) {
        OdacService odacService = getOdacService();
        RestApiAdapter.exec(bioCode, request, odacService);
    }

    @Override
    public void exec(String bioCode, Object params) {
        OdacService odacService = getOdacService();
        RestApiAdapter.exec(bioCode, params, odacService, ServletContextHolder.getCurrentUser());
    }

    @Override
    public void execLocal(SQLContext context, SQLDefinition sqlDefinition, Object params) {
        OdacService odacService = getOdacService();
        RestApiAdapter.execLocal(sqlDefinition, params, context);
    }

    @Override
    public <T> T selectScalar(final String bioCode, final HttpServletRequest request, final Class<T> clazz, final T defaultValue) {
        OdacService odacService = getOdacService();
        return RestApiAdapter.selectScalar(bioCode, request, odacService, clazz, defaultValue, ((WrappedRequest) request).getUser());
    }

    @Override
    public List<ABean> save(String bioCode, List<ABean> abeans, HttpServletRequest request) {
        OdacService odacService = getOdacService();
        return RestApiAdapter.saveBeans(bioCode, request, odacService, abeans);
    }

    @Override
    public <T> List<T> getList0(SQLContext context, String bioCode, FilterAndSorter filterAndSorter, Object prms, Class<T> calzz) {
        OdacService odacService = getOdacService();
    ...
    @Override
    public <T> List<T> getList0All(SQLContext context, String bioCode, FilterAndSorter filterAndSorter, Object prms, Class<T> calzz) {
        OdacService odacService = getOdacService();
        SQLDefinition sqldef = odacService.getSQLDefinition(bioCode);
        return RestApiAdapter.loadAll0Ext(sqldef, context, prms, calzz, filterAndSorter);
    }
    @Override
    public void execBatch(final SQLActionVoid0 action) {
        OdacService odacService = getOdacService();
        RestApiAdapter.execBatch(odacService.getSQLContext(), action, ServletContextHolder.getCurrentUser());
    }

    @Override
    public <T> T execBatch(final SQLActionScalar0<T> action) {
        OdacService odacService = getOdacService();
        return RestApiAdapter.execBatch(odacService.getSQLContext(), action, ServletContextHolder.getCurrentUser());
    }

    @Override
    public <P, T> T execBatch(final SQLActionScalar1<P, T> action, P param) {
        OdacService odacService = getOdacService();
