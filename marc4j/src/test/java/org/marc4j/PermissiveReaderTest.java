...
import org.marc4j.utils.RecordTestingUtils;
...
public class PermissiveReaderTest {
    ...
    public void testBadLeaderBytes10_11() throws Exception {
        int i = 0;
        InputStream input = Thread.currentThread().getContextClassLoader().getResourceAsStream(StaticTestRecords.RESOURCES_BAD_LEADERS_10_11_MRC);
        assertNotNull(input);
    ...
    public void testTooLongMarcRecord() throws Exception {
        InputStream input = Thread.currentThread().getContextClassLoader().getResourceAsStream(StaticTestRecords.RESOURCES_BAD_TOO_LONG_PLUS_2_MRC);
        assertNotNull(input);
    ...
    public void testTooLongMarcRecord2() throws Exception {
        InputStream input = Thread.currentThread().getContextClassLoader().getResourceAsStream(StaticTestRecords.RESOURCES_6_BYTE_OFFSET_IN_DIRECTORY);
        assertNotNull(input);
    ...
    public void testTooLongMarcRecord3() throws Exception {
        InputStream input = Thread.currentThread().getContextClassLoader().getResourceAsStream(StaticTestRecords.RESOURCES_BAD_TOO_LARGE_HATHI_RECORD);
        assertNotNull(input);
    ...
    public void testPrideAndPrejudice() throws Exception {
        InputStream input1 = Thread.currentThread().getContextClassLoader().getResourceAsStream(StaticTestRecords.RESOURCES_PRIDE_AND_PREJUDICE_ERRORS_MRC);
        InputStream input2 = Thread.currentThread().getContextClassLoader().getResourceAsStream(StaticTestRecords.RESOURCES_PRIDE_AND_PREJUDICE_FIXED_MRC);
    ...
    {
        InputStream input = Thread.currentThread().getContextClassLoader().getResourceAsStream(StaticTestRecords.RESOURCES_UNORDERED_DIRECTORY);
        assertNotNull(input);
        try
        {
            MarcReader reader = new MarcPermissiveStreamReader(input, true, true);
    ...
    public void testCyrillicEFix() throws Exception {
       InputStream input = Thread.currentThread().getContextClassLoader().getResourceAsStream(StaticTestRecords.RESOURCES_CYRILLIC_CAPITAL_E_MRC);
        assertNotNull(input);
       MarcReader reader = new MarcPermissiveStreamReader(input, true, true);
    ...
    public void testGreekMissingCharSetChange() throws Exception {
       InputStream input = Thread.currentThread().getContextClassLoader().getResourceAsStream(StaticTestRecords.RESOURCES_GREEK_MISSING_CHARSET_MRC);
        assertNotNull(input);
       MarcReader reader = new MarcPermissiveStreamReader(input, true, true);
    ...
    public void testMangledChineseCharacters() throws Exception {
       InputStream input = Thread.currentThread().getContextClassLoader().getResourceAsStream(StaticTestRecords.RESOURCES_CHINESE_MANGLED_MULTIBYTE_MRC);
       assertNotNull(input);
...
//           RecordTestingUtils.assertEqualsIgnoreLeader(record1, record2);
 ...
 //      assertNull("Tested records are unexpectedly different: "+diff12, diff12);
    ...
    public void testMalformedNCRFix() throws Exception {
       InputStream input = Thread.currentThread().getContextClassLoader().getResourceAsStream(StaticTestRecords.RESOURCES_BAD_NUMERIC_CHARACTER_REFERENCE_MRC);
        assertNotNull(input);
       MarcReader reader = new MarcPermissiveStreamReader(input, true, true, "MARC8");
    ...
    public void testIncompleteEscSeq() throws Exception {
        int i = 0;
        InputStream input = Thread.currentThread().getContextClassLoader().getResourceAsStream(StaticTestRecords.RESOURCES_INCOMPLETE_ESC_SEQ_MRC);
