...
public class RoundtripTest  {
    ...
    public void testWriteAndReadRoundtrip() throws Exception {
        ...
        InputStream inputCompare1 = Thread.currentThread().getContextClassLoader().getResourceAsStream(StaticTestRecords.RESOURCES_CHABON_MRC);
    ...
    public void testWriteAndReadRoundtripChineseConverted() throws Exception {
        InputStream input = Thread.currentThread().getContextClassLoader().getResourceAsStream(StaticTestRecords.RESOURCES_CHINESE_WITH_CENTRAL_DOT_MRC);
        assertNotNull(input);
        ByteArrayOutputStream out1 = new ByteArrayOutputStream();
        MarcStreamReader marcReader1 = new MarcStreamReader(input);
        ...
        InputStream inputCompare1 = Thread.currentThread().getContextClassLoader().getResourceAsStream(StaticTestRecords.RESOURCES_CHINESE_WITH_CENTRAL_DOT_MRC);
        InputStream inputCompare2 = new ByteArrayInputStream(out2.toByteArray());
        MarcReader readComp1 = new MarcStreamReader(inputCompare1);
        MarcReader readComp2 = new MarcStreamReader(inputCompare2);
        Record r1, r2;
    ...
    public void testConvertToXMLRoundtrip() throws Exception {
        InputStream input = Thread.currentThread().getContextClassLoader().getResourceAsStream(StaticTestRecords.RESOURCES_BRKRTEST_MRC);
       assertNotNull(input);
        ByteArrayOutputStream out1 = new ByteArrayOutputStream();
        MarcStreamReader marcReader = new MarcStreamReader(input);
        MarcXmlWriter xmlWriter = new MarcXmlWriter(out1);
    ...
    public void testConvertToXMLNormalizedRoundtrip() throws Exception {
        ...
        out2.close();
        InputStream inputCompare1 = Thread.currentThread().getContextClassLoader().getResourceAsStream(StaticTestRecords.RESOURCES_BRKRTEST_MRC);
    ...
    public void testConvertToMarc8NCRRoundtrip() throws Exception {
        InputStream input = Thread.currentThread().getContextClassLoader().getResourceAsStream(StaticTestRecords.RESOURCES_OCLC814388508_XML);
        assertNotNull(input);
        ByteArrayOutputStream out1 = new ByteArrayOutputStream();
        ...
        InputStream inputCompare1 = Thread.currentThread().getContextClassLoader().getResourceAsStream(StaticTestRecords.RESOURCES_OCLC814388508_XML);
        InputStream inputCompare2 = new ByteArrayInputStream(out2.toByteArray());
