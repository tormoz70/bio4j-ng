...
import ru.bio4j.model.transport.jstore.filter.*;
 ...
 *
 */
public class OracleWrapperInterpreter implements WrapperInterpreter {
    ...
    private static String appendAlias(String alias, String column){
        return (Strings.empty(alias) ? ""  : alias+".")+column;
    }
