Ext.define('Idbm.form.AntiquesEdit', {
            ...
            items: [
                ...
                },
                {
                    ...
                    items: [
                        ...
                        {xtype: 'biocombo', name: 'STORYTHNG_ID',
                        ...
                        {xtype: 'biocombo', name: 'STORYTHNG_ID', width: 70, allowBlank: true}
                    ]
                },
                {
                    xtype: 'fieldcontainer',
                    ...
                    items: [
                        {xtype: 'biocombo', name: 'STYLETHNG_ID',
                            store: Ext.create('Bio.data.Store', {bioCode: 'idcardantq_combo.stylethng'}), valueField: 'ID', displayField: 'AVALUE',
                            fieldLabel: 'Стиль', labelWidth: 40, minWidth: 140, flex: 1, allowBlank: false},
                        {xtype: 'displayfield', width: 6, value:";"},
                        {xtype: 'biocombo', name: 'STYLETHNG_ID',
                            store: Ext.create('Bio.data.Store', {bioCode: 'idcardantq_combo.stylethng'}), valueField: 'ID', displayField: 'AVALUE',
                            minWidth: 40, flex: 1, allowBlank: false},
                        {xtype: 'biocombo', name: 'TECHTHNG_ID',
                        ...
                        {xtype: 'biocombo', name: 'TECHTHNG_ID',
                            store: Ext.create('Bio.data.Store', {bioCode: 'idcardantq_combo.techthng'}), valueField: 'ID', displayField: 'AVALUE',
                            minWidth: 40, flex: 1, allowBlank: false},
                        {xtype: 'biocombo', name: 'COLORTHNG_ID',
                            store: Ext.create('Bio.data.Store', {bioCode: 'idcardantq_combo.colorthng'}), valueField: 'ID', displayField: 'AVALUE',
                            fieldLabel: 'Колорит', labelWidth: 50, minWidth: 130, flex: 1, allowBlank: false},
                        {xtype: 'displayfield', width: 6, value:";"},
                        {xtype: 'biocombo', name: 'COLORTHNG_ID',
                            store: Ext.create('Bio.data.Store', {bioCode: 'idcardantq_combo.colorthng'}), valueField: 'ID', displayField: 'AVALUE',
                            minWidth: 40, flex: 1, allowBlank: false}
                ...
                },
                {
                    ...
                    items: [
                        {xtype: 'biocombo', name: 'MATRLTHNG_ID',
                        ...
                        {xtype: 'biocombo', name: 'DECORTHNG_ID',
                            store: Ext.create('Bio.data.Store', {bioCode: 'idcardantq_combo.decorthng'}), valueField: 'ID', displayField: 'AVALUE',
                            minWidth: 40, flex: 1, allowBlank: false},
                        {xtype: 'biocombo', name: 'FACINGTHNG_ID',
