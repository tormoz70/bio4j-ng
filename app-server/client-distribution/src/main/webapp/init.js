...
Ext.onReady(function() {
    ...
    var doOnLoginOk = function(){
        ...
        Ext.create('Ext.idbm.RootPanel', {
            renderTo   : 'all-bservices',
            store : store
        });
    ...
    var doResize = function() {
        ...
        Ext.fly('all-bservices').setHeight(Math.floor(Math.max(availHeight, sideBoxEl.getHeight())));
        bodyStyle.overflow = '';
    };
    ...
    var firebugWarning = function () {
        ...
        if (window.console && window.console.firebug && ! cp.get('hideFBWarning')){
            ...
            var newEl = tpl.insertFirst('all-bservices');
