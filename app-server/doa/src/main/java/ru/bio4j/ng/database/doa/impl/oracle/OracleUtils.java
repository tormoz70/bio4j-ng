package ru.bio4j.ng.database.doa.impl.oracle;
...
import ru.bio4j.ng.database.doa.impl.SqlTypeConverter;
...
public class OracleUtils {
     ...
     * @return
     */
    public static OracleUtils.PackageName parsStoredProcName(String storedProcName) {
        String pkgName = null;
        ...
        PackageName pkg = new OracleUtils.PackageName(pkgName, methodName);
    	return pkg;
    }
    ...
    public static String detectStoredProcParamsAuto(String storedProcName, Connection conn) throws SQLException {
        ...
        OracleUtils.PackageName pkg = OracleUtils.parsStoredProcName(storedProcName);
